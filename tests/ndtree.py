...
class ndtree:
    ...
    def update_node(self, n, new_cost):
        ...
        if np.all(y<=n.nadir_point) or np.all(y>=n.ideal_point):
            if len(n.children) == 0:
...
for i in range(8):
    print(tree.update_tree([np.array([2**i,-2**i,0,0]),0,0,0,0]))

print(tree.root.points_list)
tree.show()
=======
import numpy as np
import heapq
...
tree.show()
>>>>>>> 9b333820f1dc4b076804123793cfad07b8198098
'''